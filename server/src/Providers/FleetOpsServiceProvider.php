...
class FleetOpsServiceProvider extends CoreServiceProvider
{
    ...
    public $commands = [
        ...
        \Fleetbase\FleetOps\Console\Commands\SendDocumentReminders::class,
        \Fleetbase\FleetOps\Console\Commands\InstallDocumentFields::class,
    ...
    public function boot()
    {
        ...
        $this->scheduleCommands(function ($schedule) {
            ...
            $schedule->command('fleetops:send-document-reminders')->daily()->withoutOverlapping()->storeOutputInDb();
